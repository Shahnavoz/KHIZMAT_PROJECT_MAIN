...
MyDocumentDetailInfoModel myDocumentDetailInfoModelFromJson(String str) =>
    MyDocumentDetailInfoModel.fromJson(json.decode(str));

String myDocumentDetailInfoModelToJson(MyDocumentDetailInfoModel data) =>
...
class MyDocumentDetailInfoModel {
  ...
  factory MyDocumentDetailInfoModel.fromJson(Map<String, dynamic> json) =>
      MyDocumentDetailInfoModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    activityAddresses: List<dynamic>.from(
      json["activity_addresses"].map((x) => x),
    ),
    ...
    pkiSignatures:
        json["pkiSignatures"] != null && json["pkiSignatures"] is Map
            ? PkiSignatures.fromJson(
              json["pkiSignatures"] as Map<String, dynamic>,
            )
            : null,
...
class Addition {
  ...
  factory Addition.fromJson(Map<String, dynamic> json) => Addition(
    ...
    value: json["value"],
    duplicableValues:
        json["duplicable_values"] == null
            ? []
            : List<DuplicableValue>.from(
              json["duplicable_values"]!.map(
                (x) => DuplicableValue.fromJson(x),
              ),
            ),
    type: json["type"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "value": value,
    "duplicable_values":
        duplicableValues == null
            ? []
            : List<dynamic>.from(duplicableValues!.map((x) => x.toJson())),
    "type": type,
  };
}
...
class DuplicableValue {
  ...
  factory DuplicableValue.fromJson(Map<String, dynamic> json) =>
      DuplicableValue(
        ...
        value: json["value"],
        option:
            json["option"] == null ? null : Document.fromJson(json["option"]),
      );
...
class Application {
  ...
  factory Application.fromJson(Map<String, dynamic> json) => Application(
    ...
    billingInvoiceDtos: List<dynamic>.from(
      json["billingInvoiceDtos"].map((x) => x),
    ),
...
class ApplicationType {
  ...
  ApplicationType({required this.key, required this.title});
  ...
  Map<String, dynamic> toJson() => {"key": key, "title": title.toJson()};
}
...
class ReviewStatusClass {
  ...
  factory ReviewStatusClass.fromJson(Map<String, dynamic> json) =>
      ReviewStatusClass(
        key: json["key"],
        title: Document.fromJson(json["title"]),
...
class Step {
  ...
  Step({required this.title, required this.position, required this.count});
