...
SubcategoryByDocumentIdModel subcategoryByDocumentIdModelFromJson(String str) =>
    SubcategoryByDocumentIdModel.fromJson(json.decode(str));

String subcategoryByDocumentIdModelToJson(SubcategoryByDocumentIdModel data) =>
    json.encode(data.toJson());

class SubcategoryByDocumentIdModel {
  int statusCode;
  String statusMessage;
  Data data;

  SubcategoryByDocumentIdModel({
    required this.statusCode,
    required this.statusMessage,
    required this.data,
  });

  factory SubcategoryByDocumentIdModel.fromJson(Map<String, dynamic> json) =>
      SubcategoryByDocumentIdModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    applicantTypes: List<String>.from(json["applicant_types"].map((x) => x)),
...
class ApplicantType {
  ...
  factory ApplicantType.fromJson(Map<String, dynamic> json) =>
      ApplicantType(tj: json["tj"], ru: json["ru"], en: json["en"]);
